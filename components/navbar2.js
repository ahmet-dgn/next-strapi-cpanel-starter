...
export function Navbar2({ menuData, generalSettings, t }) {
  ...
  return (
    ...
    >
      <div className="flex justify-between lg:justify-start items-center 2xl:container mx-auto px-4 xl:px-8 min-h-[6rem]">
        <Link href="/">
          <Image
        ...
        >
          <div className="flex justify-between  flex-col lg:flex-row lg:items-center">
            <ul className="text-link-small pt-4 lg:pt-0 lg:pl-8 lg:flex lg:justify-center flex-1">
              {menuItems
