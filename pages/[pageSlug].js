...
export const getServerSideProps = async ({ params, locale, defaultLocale }) => {
  ...
  const initialRes = await fetch(
    `${process.env.DATA_URL}/api/pages?populate=Blocks.Content.Image&populate=Image&populate=Blocks.Image&populate=localizations&populate=Blocks.products.MainImage&populate=Blocks.products.category&populate=SEO&locale=all&filters[Slug][$eq]=${pageSlug}`
  );
  ...
  if (
    ...
    const translationRes = await fetch(
      `${process.env.DATA_URL}/api/pages?populate=Blocks.Content.Image&populate=Image&populate=Blocks.Image&populate=localizations&populate=Blocks.products.MainImage&populate=Blocks.products.category&populate=SEO&locale=all&filters[Slug][$eq]=${translatedSlug}`
    );
